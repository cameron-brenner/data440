...
Original file is located at
    https://colab.research.google.com/drive/1sYjdTx6aTeqAPukaTHxSFq-xg0lz-eeL
"""
...
for neurons in range(1,101,1):
  for eta in range(1,11,1):
    ...
    for train, validation in kf.split(X):
      ...
      mlp =  MLPRegressor(hidden_layer_sizes=(neurons,), verbose=False, learning_rate_init=eta, max_iter=500)
